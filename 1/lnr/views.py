...
from PIL import Image, ImageDraw, ImageFont, ImageFilter#PIL插件的文件
...
def getCAPTCHA(request):
    ...
    if nowsys == 'Darwin':
        ...
        font = ImageFont.truetype(font_file, font_size) # the font object
        #font = ImageFont.truetype('Arial.ttf',font_size)
    else:
        return HttpResponse('system Error From getCAPTCHA---->nowsys:' + nowsys)
    #新建画布
